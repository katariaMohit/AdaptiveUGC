...
# class DataGraphSAINT_coarsen:
#     '''datasets used in GraphSAINT paper'''

#     def __init__(self, dataset, adj_full, idx_train, idx_test, idx_val, feat, feat,  **kwargs):



#         # dataset_str= data_read_path + '/data/'+dataset+'/'
#         # adj_full = sp.load_npz(dataset_str+'adj_full.npz')
        
#         self.nnodes = adj_full.shape[0]
#         if dataset == 'ogbn-arxiv' or dataset == 'ogbn-products':
